...
>
	<div class="shell flex h-16 items-center justify-between gap-3">
		...
		<div class="flex items-center gap-2">
			...
			>
				<svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor" class="anim-ring" aria-hidden="true">
					<path
...
{#if mobileOpen}
	<div id="mobile-menu" class="mobile-sheet md:hidden" use:trapFocus={{ inert: 'main, footer' }}>
		<nav class="shell flex flex-col gap-1 py-6">
			{#each links as link (link.href)}
				<a
					href={link.href}
